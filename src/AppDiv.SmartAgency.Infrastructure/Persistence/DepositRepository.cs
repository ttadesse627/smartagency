...
namespace AppDiv.SmartAgency.Infrastructure.Persistence
{
    public class DepositRepository : BaseRepository<Deposit>, IDepositRepository
    {
        ...
        public async Task<int> GetApplicantPassportByPassportNumber(string passportNumber)
        {
            return await _context.Deposits.CountAsync(dep => dep.PassportNumber == passportNumber);
        }
    }
