    ...
    internal class SeedData
    {
        ...
        internal static void SeedprocessDefinitions(ModelBuilder builder)
        {
            var pDefs = new List<ProcessDefinition>
            {
                ...
                new ProcessDefinition {Id = Guid.Parse("5b912c00-9df3-47a1-a525-410abf239616"), Name = "Travel", Step = 2, RequestApproval = false, ProcessId = Guid.Parse("60209c9d-47b4-497b-8abd-94a753814a86") },
                new ProcessDefinition {Id = Guid.Parse("6b912c00-9df3-47a1-a524-410abf239616"), Name = "Traveled", Step = 3, RequestApproval = true, ProcessId = Guid.Parse("60209c9d-47b4-497b-8abd-94a753814a86") }
            };
