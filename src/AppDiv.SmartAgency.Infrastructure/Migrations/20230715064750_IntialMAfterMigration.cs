...
{
    public partial class IntialMAfterMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2023, 7, 15, 9, 47, 49, 638, DateTimeKind.Local).AddTicks(344)),
                    ModifiedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ModifiedBy = table.Column<string>(type: "longtext", nullable: true)
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("60209c9d-47b4-497b-8abd-94a753814a86"), null, new DateTime(2023, 7, 15, 9, 47, 49, 643, DateTimeKind.Local).AddTicks(6664), null, false, null, null, "Ticket Process", 100, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00fa1a8e-ac70-400e-8f37-20010f81a27a"), new DateTime(2023, 7, 15, 9, 47, 49, 643, DateTimeKind.Local).AddTicks(6846), null, 0, null, null, "Ready to Issue Ticket", new Guid("60209c9d-47b4-497b-8abd-94a753814a86"), false, 0 },
                    { new Guid("1dc479ab-fe84-4ca8-828f-9a21de7434e7"), new DateTime(2023, 7, 15, 9, 47, 49, 643, DateTimeKind.Local).AddTicks(6859), null, 0, null, null, "Register Ticket", new Guid("60209c9d-47b4-497b-8abd-94a753814a86"), false, 1 },
                    { new Guid("2d9ef769-6d03-4406-9849-430ff9723778"), new DateTime(2023, 7, 15, 9, 47, 49, 643, DateTimeKind.Local).AddTicks(6863), null, 0, null, null, "Refund Ticket", new Guid("60209c9d-47b4-497b-8abd-94a753814a86"), false, 2 },
                    { new Guid("3048b353-039d-41b6-8690-a9aaa2e679cf"), new DateTime(2023, 7, 15, 9, 47, 49, 643, DateTimeKind.Local).AddTicks(6867), null, 0, null, null, "Rebook Ticket", new Guid("60209c9d-47b4-497b-8abd-94a753814a86"), false, 3 },
                    { new Guid("4048b353-039d-41b6-8690-a9aaa2e679cf"), new DateTime(2023, 7, 15, 9, 47, 49, 643, DateTimeKind.Local).AddTicks(6872), null, 0, null, null, "Register Rebook Ticket", new Guid("60209c9d-47b4-497b-8abd-94a753814a86"), false, 4 },
                    { new Guid("5b912c00-9df3-47a1-a525-410abf239616"), new DateTime(2023, 7, 15, 9, 47, 49, 643, DateTimeKind.Local).AddTicks(6878), null, 0, null, null, "Travel", new Guid("60209c9d-47b4-497b-8abd-94a753814a86"), true, 2 }
                });
