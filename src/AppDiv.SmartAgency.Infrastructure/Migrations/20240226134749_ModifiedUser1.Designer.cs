...
namespace AppDiv.SmartAgency.Infrastructure.Migrations
{
    ...
    [Migration("20240226134749_ModifiedUser1")]
    partial class ModifiedUser1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppDiv.SmartAgency.Domain.Entities.Applicants.RequestedApplicant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AppDiv.SmartAgency.Domain.Entities.Process", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3308),
                            EnjazRequired = false,
                            Name = "Ticket Process",
                            Step = 100,
                            VisaRequired = true
            ...
            modelBuilder.Entity("AppDiv.SmartAgency.Domain.Entities.ProcessDefinition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3655),
                            ExpiryInterval = 0,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3665),
                            ExpiryInterval = 0,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3671),
                            ExpiryInterval = 0,
                            Name = "Refund Ticket",
                            ProcessId = new Guid("60209c9d-47b4-497b-8abd-94a753814a86"),
                            RequestApproval = false,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3675),
                            ExpiryInterval = 0,
                            Name = "Rebook Ticket",
                            ProcessId = new Guid("60209c9d-47b4-497b-8abd-94a753814a86"),
                            RequestApproval = false,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3680),
                            ExpiryInterval = 0,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3698),
                            ExpiryInterval = 0,
                            Name = "Travel",
                            ProcessId = new Guid("60209c9d-47b4-497b-8abd-94a753814a86"),
                            RequestApproval = false,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 26, 16, 47, 48, 712, DateTimeKind.Local).AddTicks(3702),
                            ExpiryInterval = 0,
                            Name = "Traveled",
                            ProcessId = new Guid("60209c9d-47b4-497b-8abd-94a753814a86"),
            ...
            modelBuilder.Entity("AppDiv.SmartAgency.Domain.Entities.Settings.Suffix", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 2, 26, 16, 47, 48, 703, DateTimeKind.Local).AddTicks(2345));
            ...
            modelBuilder.Entity("AppDiv.SmartAgency.Domain.Entities.Applicants.RequestedApplicant", b =>
                {
                    b.HasOne("AppDiv.SmartAgency.Domain.Entities.Applicants.Applicant", "Applicant")
                        .WithOne("RequestedApplicant")
                        .HasForeignKey("AppDiv.SmartAgency.Domain.Entities.Applicants.RequestedApplicant", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppDiv.SmartAgency.Domain.Entities.Partner", "Partner")
                        .WithMany("RequestedApplicants")
                        .HasForeignKey("PartnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AppDiv.SmartAgency.Domain.Entities.Applicants.Applicant", b =>
                {
                    ...
                    b.Navigation("RequestedApplicant");
            ...
            modelBuilder.Entity("AppDiv.SmartAgency.Domain.Entities.Partner", b =>
                {
                    ...
                    b.Navigation("RequestedApplicants");
