...
public record StepbackTicketCommand(StepbackProcessRequest Request) : IRequest<ApplicantProcessResponseDTO> { }
public class StepbackTicketCommandHandler : IRequestHandler<StepbackTicketCommand, ApplicantProcessResponseDTO>
{
    ...
    public async Task<ApplicantProcessResponseDTO> Handle(StepbackTicketCommand command, CancellationToken cancellationToken)
    {
