...
using AppDiv.SmartAgency.Application.Features.Command.Create.Pagess;
using AppDiv.SmartAgency.Application.Features.Command.Delete.Pagess;
using AppDiv.SmartAgency.Application.Features.Command.Update.Pagess;
using AppDiv.SmartAgency.Application.Features.Query.Pagess;
    ...
    public class PageController: ControllerBase
{
    ...
    [HttpGet("get-all-pages")]
     ...
     [HttpGet("{id}")]
        ...
        public async Task<PageResponseDTO> Get(Guid id)
        {
